...
MAX_HISTORY_LENGTH      : int  = get('play-history-max')
ALLOW_SPOTIFY_PLAYLISTS : bool = get('allow-spotify-playlists')
MAX_PLAYLIST_LENGTH     : int  = get('playlist-track-limit')
MAX_ALBUM_LENGTH        : int  = get('album-track-limit')
MAX_CONSECUTIVE_URLS    : int  = get('maximum-urls')
